...
public class medicalSurveyAdapter extends BaseAdapter {
    Context context;
    int layout;
    LayoutInflater inf;
    ...
    public medicalSurveyAdapter(Context context, int layout, ArrayList<SurveyViewItem> lv) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView txtView = (TextView) convertView.findViewById(R.id.disease);
        final RadioButton btn1 = (RadioButton) convertView.findViewById(R.id.year1);
        final RadioButton btn2 = (RadioButton) convertView.findViewById(R.id.year3);
        final RadioButton btn3 = (RadioButton) convertView.findViewById(R.id.year5);
        final RadioButton btn4 = (RadioButton) convertView.findViewById(R.id.none);
