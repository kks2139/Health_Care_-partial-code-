...
public class SurveySleep extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    int point = 7;
    int lightColor = Color.rgb(255, 215, 91);
    int deepColor = Color.rgb(255, 138, 0);
    int size = 200;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey_sleep);
        ...
        final surveyAdapter adapter = new surveyAdapter(getApplicationContext(), R.layout.survey_sleep_item, lv);
        ...
        basicBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveySleep.this, BasicSurvey1.class);
        ...
        totalEvalBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveySleep.this, SurveyTotalEval.class);
                startActivity(intent);
            }
        });
        ...
        adviceBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveySleep.this, Advice.class);
                startActivity(intent);
            }
        });
        ...
        // add data
        setData(point);
        //Toast.makeText(getApplicationContext(),"ppp"+point,Toast.LENGTH_SHORT).show();
        mlnChart.animateX(0);
        ...
        leftAxis.setDrawGridLines(true);//draw the line
