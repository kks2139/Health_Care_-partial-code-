...
public class SurveyFatigue extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    int point = 7;
    int lightColor = Color.rgb(156, 209, 150);
    int deepColor = Color.rgb(49, 171, 36);
    int size = 200;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey_fatigue);
        ...
        final surveyAdapter adapter = new surveyAdapter(getApplicationContext(), R.layout.survey_fatigue_item, lv);
        ...
        basicBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveyFatigue.this, BasicSurvey1.class);
        ...
        totalEvalBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveyFatigue.this, SurveyTotalEval.class);
                startActivity(intent);
            }
        });
        ...
        adviceBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SurveyFatigue.this, Advice.class);
                startActivity(intent);
            }
        });
